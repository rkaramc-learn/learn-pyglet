...
| **mouse_sheet** | `sprites/mouse_sheet.png` | Sprite Sheet (PNG) | 0.95 MB | ❌ No | Generated from `mouse.mp4` | ⚠️ Ignored |
| **ambience** | `audio/music/ambience.wav` | Background Music (WAV) | 8.5 MB | ❌ No | External source | ⚠️ Ignored |
| **mouse.mp4** | `source/mouse.mp4` | Source Video (MP4) | 1.2 MB | ❌ No | Source file | ⚠️ Ignored |
...
2. **Generate using synthesis** (e.g., procedural audio generation)
3. **Provide sourcing instructions** (point users to Creative Commons sources)
...
2. **Link to Creative Commons video source** (if applicable)
3. **Provide recording instructions** (if hand-captured)
